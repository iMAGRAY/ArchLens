...
impl MetricsCalculator {
    ...
    pub fn calculate_dependency_depth(&self, capsule_id: Uuid, relations: &[CapsuleRelation], visited: &mut Vec<Uuid>) -> u32 {
        if visited.contains(&capsule_id) {
    ...
    pub fn calculate_coupling_metrics(&self, capsules: &HashMap<Uuid, Capsule>, relations: &[CapsuleRelation]) -> CouplingMetrics {
        let total_capsules = capsules.len();
        ...
        CouplingMetrics {
            average_afferent_coupling: afferent_coupling.values().sum::<u32>() as f32 / total_capsules as f32,
            average_efferent_coupling: efferent_coupling.values().sum::<u32>() as f32 / total_capsules as f32,
            average_instability,
    ...
    pub fn calculate_cohesion_metrics(&self, capsules: &HashMap<Uuid, Capsule>, relations: &[CapsuleRelation]) -> CohesionMetrics {
        ...
        CohesionMetrics {
            average_layer_cohesion: if layer_count > 0 { layer_cohesion_sum / layer_count as f32 } else { 0.0 },
    ...
    pub fn calculate_complexity_distribution(&self, capsules: &HashMap<Uuid, Capsule>) -> ComplexityDistribution {
